...
RUN_DIR = [ '/Volumes/gill/cs385/Lectures/Week12_Nov06_CS385/assignment3/experiments/bag_of_words' ];

%%% Directory holding all the source images
IMAGE_DIR = [ '/Volumes/gill/cs385/Lectures/Week12_Nov06_CS385/assignment3/images' ];
